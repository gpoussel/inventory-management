...
/* Saturated data series colors — kept as-is for both themes */
...
/* Revenue bar uses primary text color so it adapts to theme */
...
/* Revenue bar adopts primary text color so it contrasts in both themes */
.revenue-bar {
